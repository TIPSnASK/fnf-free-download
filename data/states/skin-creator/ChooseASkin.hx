...
function postCreate() {
	...
	yourName = new UITextBox(5, dumbBar2.y + 4, (userSkins.name == null || userSkins.name == "") ? "type your name" : userSkins.name, (FlxG.width/2) - 10, 32);
	add(yourName);

	theyAddedPronounsToFreeDownload = new UITextBox((FlxG.width/2), dumbBar2.y + 4, (userSkins.pronouns == null || userSkins.pronouns == "") ? "they/them/theirs" : userSkins.pronouns, (FlxG.width/2) - 5, 32);
